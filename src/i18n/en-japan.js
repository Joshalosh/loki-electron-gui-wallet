export default {
    ...
    fieldLabels: {
        ...
        priority: "優先",
        remoteNodeHost: "レモート・ノードホースト",
        remoteNodePort: "レモート・ノードポート",
        restoreFromBlockHeight: "ブロック・ハイトから復元",
        restoreFromDate: "日付から復元",
        seedLanguage: "シードの言語設定",
        serviceNodeCommand: "レモート・ノード COMMAND",
        serviceNodeKey: "サービス・ノードキー",
        ...
        rescanFullBlockchain: "全体ブロックチェーンを再スキャン",
        rescanSpentOutputs: "使用済み出力を再スキャン",
        transactionNotes: "取引のメモ"
    },
    footer: {
        ready: "準備が整いました",
        scanning: "確認中",
    ...
    notification: {
        ...
        errors: {
            ...
            enterSeedWords: "シード・ワードズを入力してください",
